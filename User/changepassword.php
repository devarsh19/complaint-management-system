<?php
          error_reporting(0);
           ...
           if(isset($_POST['submit'])){
            $Currentpassword = md5(mysqli_real_escape_string($connect, $_POST['Currentpassword']));
          //echo $Currentpassword."       ";
            $sql1 = "SELECT Password FROM reg_data WHERE Email ='$mail'";
            ...
            if($Currentpassword==$password){
              ...
              $Newpassword = md5(mysqli_real_escape_string($connect, $_POST['Newpassword']));
              $Confirmpassword = md5(mysqli_real_escape_string($connect, $_POST['Confirmpassword']));
              $sql2 = "UPDATE reg_data SET password='$Confirmpassword'  WHERE Email ='$mail'";
            ...
            <div class="row form-group">
                <div class="col-md-12">
                    <div class="col-md-2 submitcancelbutton">
                        ...
                        <button name="submit" id="submit" class="btn btn-md btn-primary">Submit</button>
                    <!--/div-->
                    <!--div class="col-md-2"-->
