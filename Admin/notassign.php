...
<head>
  ...
  <title>Admin - Not-assigned Complaints</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Not assigned Complaints</li>
      </ol>
<!-- Display pending complaint here -->
    <div class="card-header">
          <i class="fa fa-table"></i> &nbsp Not assigned Complaints</div>
...
//          }
      $sql3 = "SELECT A.Complaint_id,A.Date,B.Complaint_type,C.Operator_name,A.Subject,A.Description FROM complaint_master A, complaint_type_master B, operator_master C WHERE A.Operator_id=C.Operator_id AND A.Complaint_type_id=B.Complaint_type_id AND A.Status_id = '4' ";
