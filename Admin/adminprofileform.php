<?php 
      error_reporting(0);
           ...
           $image = mysqli_real_escape_string($connect, $_POST['fileToUpload']);
  ...
  window.location.href='adminprofileform.php';
  </script>" ;
}
...
<div class="wrapper row3">
  <main id="container" class="clear">
    <div class="col-md-12">
      <div class="col-md-6">
        <h2 style="color: #002266;margin-left: 22px">Admin's profile</h2>
      </div>
      <div class="col-md-6" style="width:150px;height:150px;float:right;margin-right: 70px">
        <img id="image" src="" style="width:150px;height:150px;" alt="profile picture is not uploaded">
      </div>  
    </div>  
    <!-- container body -->
    <!-- ########################################################################################## -->
    <div id="FeedbackForm">
      <form action="adminprofileform.php" class="myForm form-inline" class="form-horizontal" method="POST" enctype="multipart/form-data">
        <fieldset>
                ...
                <label for="Firstname" class="control-label" id="abc" style="font-size: 20px">First Name:
                  ...
                  <div class="col-md-8">
                   <input type="text" name="fname" id="fname" tabindex="1" class="form-control" placeholder="Firstname" value="<?php error_reporting(0); echo $Firstname; ?>">
                    </div>
            </div>
            ...
            <div class="row form-group">
                ...
                <label for="Email" class="control-label" style="font-size: 20px">Email:
                  ...
                  <div class="col-md-8">
                    <input type="email" name="email" id="email" tabindex="1" class="form-control" placeholder="Email Address" value="<?php error_reporting(0); echo $mail; ?>" onkeyup="emailvalidate()"></div>
