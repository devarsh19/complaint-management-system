<!--<?php
    session_start();
            if(!isset($_SESSION['name'])){
                  header("location:http://localhost/project sem 8 new/login.php");
            }
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Area Chart Example-->
      <!-- this part deleted-->
      <div class=" row col-sm-9" id="table">
        <div class="col-lg-8">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="http://localhost/project sem 8 new/logout.php">Logout</a>
          </div>
        </div>
      </div>
    </div>
