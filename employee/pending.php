...
<head>
  ...
  <title>SB employee - Start Bootstrap Template</title>
  <!-- Bootstrap core CSS-->
  ...
  <?php 
      ...
      while($row = mysqli_fetch_assoc($result1))
    {
     ...
     // echo $u_id;
      ...
      $sql3 = "SELECT Complaint_id,Date,Subject,Description FROM complaint_master WHERE Status_id = 2 AND Operator_id = '$o_id' ";
