<?php 
  ...
  window.location.href='employeeprofileform.php';
  </script>" ;
...
<div class="wrapper row3">
  <main id="container" class="clear">
    <h2 style="color: #002266;margin-left: 22px">Employee's profile</h2>
    <!-- container body -->
    <!-- ########################################################################################## -->
    <div id="FeedbackForm">
      <form action="employeeprofileform.php" class="myForm form-inline" class="form-horizontal" method="POST" enctype="multipart/form-data">
        <fieldset>
