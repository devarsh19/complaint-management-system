...
<!-- Display completed complaints here -->
    <div class="card-header">
          <i class="fa fa-table"></i> &nbsp Completed Complaints</div>
    <table class="table table-bordered" class="table table-stripted" >
  <?php 
      ...
      while($row = mysqli_fetch_assoc($result1))
    {
     ...
     // echo $u_id;
      ...
      $sql3 = "SELECT Complaint_id,Date,Subject,Description FROM complaint_master WHERE Status_id = 1 AND Operator_id = '$o_id' ";
  ...
  ?>      
      <tr>
        ...
        <td>Date when complaint is completed</td>
      </tr>
  <?php
       }
  ?>
