...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <main id="container" class="clear">
    <h2 style="color: #002266; margin-left: 30px">Change complaint status</h2>
    <!-- container body -->
    <!-- ########################################################################################## -->
...
if(isset($_POST['submit'])){
  ...
  $sql4 = "UPDATE complaint_master SET Status_id = '$s_id' WHERE Complaint_id ='$complaint_id' ";
